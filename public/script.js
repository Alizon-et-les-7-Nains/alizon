...
// ASIDE (RECAP)
// ============================================================================
define("frontoffice/paiement-aside", ["require", "exports"], function (
  require,
  exports
) {
  "use strict";
...
// CART MANAGEMENT
// ============================================================================
define("frontoffice/paiement-cart", ["require", "exports"], function (
  require,
  exports
) {
  "use strict";
  ...
  exports.getDefaultCart = getDefaultCart;
  exports.getCartFromData = getCartFromData;
...
define("frontoffice/paiement-popup", ["require", "exports"], function (
  ...
  function showPopup(message) {
    ...
    const adresse =
      document
        .querySelector("body.pagePaiement .adresse-input")
        ?.value.trim() || "";
    const codePostal =
      document
        .querySelector("body.pagePaiement .code-postal-input")
        ?.value.trim() || "";
    const ville =
      document.querySelector("body.pagePaiement .ville-input")?.value.trim() ||
      "";
    const rawNumCarte =
      document
        .querySelector("body.pagePaiement .num-carte")
        ?.value.replace(/\s+/g, "") || "";
...
define("frontoffice/paiement-main", [
  ...
  "frontoffice/paiement-aside",
  "frontoffice/paiement-cart",
], function (
  require,
  exports,
  ...
  if (document.body.classList.contains("pagePaiement")) {
    ...
    const aside = (0, paiement_aside_1.initAside)(
      "#recap",
      cart,
      handleUpdateQty,
      handleRemoveItem
