                ...
                <section class="commande">
                    ...
                    <section class="footerCommande">
                        ...
                        <div class="liensCommande">
                            ...
                            <a onclick="popUpDetailsCommande('<?= $commande['id'] ?>', '<?= $commande['date'] ?>', '<?= addslashes($adresseFacturation) ?>', '<?= addslashes($adresseLivraison) ?>', '<?= $commande['statut'] ?>', '<?= $commande['transporteur'] ?>', '<?= $commande['montant'] ?>', '<?= $commande['montantHT'] ?>')" href="#">Détails</a>
