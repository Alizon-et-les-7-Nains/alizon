                ...
                <section class="commande">
                                ...
                                <div class="infoProduit">
                                    ...
                                    <div
                                        ...
                                        <?php else: ?>
                                            ...
                                            <a href="../../delivraptor/php/clientSocketSuivieEtape.php?idCommande=<?= $commande['id'] ?>">Suivre (<?php echo htmlspecialchars($commande['transporteur']); ?>) <img src="../../public/images/truckWhite.svg" alt="Icône"></a>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
                    ...
                    <section class="footerCommande">
                        ...
                        <div class="infoCommande">
                            ...
                            <p><?php echo floatval($commande['total']) * 1.2; ?> €</p>
                            <?php var_dump((float)$commande['total']);?>
