    ...
    if (this.checked) {
        ...
        .then((data) => {
            if (data.success) {
                ...
                if (data.otpauthUrl) {
                    ...
                    const otpauthUrl = "otpauth://totp/MonSite:TestUser?secret=JBSWY3DPEHPK3PXP&issuer=MonSite";
                ...
                alert("Une erreur est survenue lors de l'activation de l'authentification à deux facteurs.");
                this.checked = false;
            }
        })
        .catch((error) => {
        ...
        .then((data) => {
            if (data.success) {
                ...
                alert("Une erreur est survenue lors de la désactivation de l'authentification à deux facteurs.");
                this.checked = true;
            }
        })
        .catch((error) => {
